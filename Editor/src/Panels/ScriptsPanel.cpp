...
namespace Editor {
	...
	std::string ScriptsPanel::GenerateScriptTemplate(const std::string& className) {
		...
		ss << " */\n";
		ss << "class " << className << " : public NE::Scripting::IScript {\n";
		ss << "public:\n";
		ss << "\t" << className << "() {\n";
		...
		ss << "\t}\n";
		ss << "\n";
		ss << "\tvoid Initialize(NE::Scripting::Entity entity) override {\n";
		...
		ss << "\n";
		ss << "\tvoid OnCollisionEnter(NE::Scripting::Entity other) override {\n";
		ss << "\t\t// Called when this entity starts colliding with another\n";
		ss << "\t}\n";
		ss << "\n";
		ss << "\tvoid OnCollisionExit(NE::Scripting::Entity other) override {\n";
		ss << "\t\t// Called when this entity stops colliding with another\n";
		ss << "\t}\n";
		ss << "\n";
		ss << "\tvoid OnTriggerEnter(NE::Scripting::Entity other) override {\n";
		ss << "\t\t// Called when this entity enters a trigger\n";
		ss << "\t}\n";
		ss << "\n";
		ss << "\tvoid OnTriggerExit(NE::Scripting::Entity other) override {\n";
