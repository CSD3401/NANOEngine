...
namespace NE::ECS::Component {
    ...
    struct UICanvas {
        ...
        // Runtime only (not serialized — adding to NE_REFLECT would break existing scene files)
        float alpha = 1.0f;   // Canvas-level opacity; set via inspector or script at runtime
