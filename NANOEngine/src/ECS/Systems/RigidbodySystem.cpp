...
namespace NANOEngine::ECS::Systems {
	...
	void RigidbodySystem::OnEntityAdded(Entity entity)
	{
		...
		//if (col->shapeType == Component::Collider::ShapeType::None) {
		//	switch (col->shapeType) {
		//	case Component::Collider::ShapeType::Box: {
		//		col->shape = new JPH::BoxShape({ col->halfExtents.x, col->halfExtents.y, col->halfExtents.z });
		//		break;
		//	}
		//	case Component::Collider::ShapeType::Sphere: {
		//		col->shape = new JPH::SphereShape(col->radius);
		//		break;
		//	}
		//	case Component::Collider::ShapeType::Capsule: {
		//		col->shape = new JPH::CapsuleShape(col->height * 0.5f, col->radius);
		//		break;
		//	}
		//	}
		//	shape = col->shape;
		//}
		//else {
		//	shape = new JPH::BoxShape({ 0.5f, 0.5f, 0.5f });
		//}
		...
		rb.bodyID = Physics::PhysicsManager::CreateBody(settings).GetIndex();
	}
